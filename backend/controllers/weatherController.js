...
module.exports = {
  ...
  create: function (req, res) {
    ...
    //naredimo lahko:
    //ko pošljemo podatke, se vremena sproti brišejo in nova dodajajo.
    //imamo ogromno vremen iz istega kraja v bazi
    //imamo vreme samo 5-10 mest
  ...
  update: function (req, res) {
    ...
    WeatherModel.findOne({ _id: id }, function (err, weather) {
      ...
      weather.cloudinessId = req.body.cloudinessId
        ? req.body.cloudinessId
        : weather.cloudinessId;
      weather.temparature = req.body.temparature
        ? req.body.temparature
        : weather.temparature;
